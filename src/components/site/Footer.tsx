...
import { FlaskConical, Mail, Globe, MapPin, Instagram } from "lucide-react";
    ...
    <>
      ...
      <div className="container-px py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            <h4 className="text-sm font-semibold mb-5 tracking-wide uppercase text-foreground/80">Contact & Social</h4>
            <ul className="space-y-3 text-sm text-muted-foreground">
              ...
              {/* Socials */}
              <li className="flex items-center gap-2.5 group pt-3 mt-3 border-t border-border/40">
                <Instagram className="h-4 w-4 text-primary-glow group-hover:scale-110 transition-transform duration-300" />
                <a href="https://www.instagram.com/chemfixconstruction?igsh=MXg0YXozaDhnY3M4eQ==" target="_blank" rel="noopener noreferrer" className="hover:text-primary-glow transition">Instagram</a>
              </li>
              <li className="flex items-center gap-2.5 group">
                ...
                <a href="https://whatsapp.com/channel/0029VbArZ1l9Gv7Pz6PiOr1V" target="_blank" rel="noopener noreferrer" className="hover:text-primary-glow transition">WhatsApp Channel</a>
              </li>
            </ul>
          </div>
        </div>
      ...
      <a
        ...
        className="fixed bottom-6 right-6 sm:bottom-8 sm:right-8 z-[99999] flex h-14 w-14 sm:h-16 sm:w-16 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_0_25px_rgba(37,211,102,0.5)] transition-all duration-300 hover:-translate-y-1 hover:scale-110 hover:brightness-110 hover:shadow-[0_0_35px_rgba(37,211,102,0.8)]"
